...
class MyLcd {
  ...
  void showMeasuredDateScreen4(int lUpJoy_X, int rUpJoy_X, int lDownJoy_X, int rDownJoy_X, int lUpJoy_Y, int rUpJoy_Y, int lDownJoy_Y, int rDownJoy_Y, String btnsString, String lcdString3);
